		...
		<div class="d-flex justify-content-around h-100">
				...
				<form action="<%=application.getContextPath()%>/MainSearch"
					...
					<div class="searchbar" style="border: 3px solid green;">
						<input class="search_input" type="text" name="ncategory"
							placeholder="검색" style=""> <input type="submit" value=""
							class="btn_submit" />
			...
			<div>
				...
				<c:if test="${empty memberNickname }">
					<a href="<%=application.getContextPath()%>/member/login-view" class="btn btn-outline-success">로그인</a>
					<a href="<%=application.getContextPath()%>/practice/contract" class="btn btn-outline-success">회원가입</a>
				</c:if>
